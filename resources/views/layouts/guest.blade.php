...
<body>
    <header class="navbar <?php echo isset($isInnerPage) && $isInnerPage ? 'inner-page-navbar' : ''; ?>">
        <div class="container nav-container">
            <a href="/" class="logo"><img src="/assets/images/globeotrip.png" alt="Travel Agency Logo"
                    class="logo-img"></a>
        ...
        <div class="container">
            <div class="row g-4 footer-grid">
                <div class="col-12 col-md-4 footer-col">
                    <a href="/"> <img src="/assets/images/globeotrip.png" alt="Travel Agency Logo"
                            class="footer-logo"></a>
                ...
                <div class="col-12 col-md-2 footer-col">
                    ...
                    <a href="tel:+1-888-354-2147" class="mt-2 d-inline-block font-weight-bold text-theme-primary"><i
                            class="fas fa-phone-alt"></i> +1-888-354-2147</a>
                </div>
                <div class="col-12 col-md-4 footer-col">
                    <h4>Newsletter</h4>
